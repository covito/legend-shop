...
<html>
    ...
    <body>
        <form action="<ls:url address='/admin/system/district/savecity'/>" method="post" id="form1">
            <input id="id" name="id" value="${city.id}" type="hidden">
             <input id="provinceid" name="provinceid" value="${province.id}" type="hidden">
            <div align="center">
		...
		<tr>
		        ...
		        <td>
		           	<input type="text" name="city" id="city" value="${city.city}"   maxlength="50"/>
		        </td>
		</tr>
		<tr>
		        <td>
		        ...
		        <td>
		           	<input type="text" name="cityid" id="cityid" value="${city.cityid}"  maxlength="20"/>
		        </td>
		</tr>
                <tr>
                    <td colspan="2">
